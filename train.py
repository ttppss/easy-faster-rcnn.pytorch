...
if __name__ == '__main__':
    def main():
        ...
        parser.add_argument('-d', '--data_dir', type=str, default='/data1/zinan_xiong/easy-faster-rcnn.pytorch/data', help='path to data directory')
        parser.add_argument('-o', '--outputs_dir', type=str, default='/data1/zinan_xiong/easy-faster-rcnn.pytorch/outputs', help='path to outputs directory')
